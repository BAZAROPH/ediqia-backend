...
Paydunya_Checkout_Store::setLogoUrl("http://www.chez-sandra.sn/logo.png");
    ...
    public function reabonnement(Request $request)
    {
        ...
        //3-creation de l'abonnement
            ...
            $last_abonnement = DB::table('abonnements')->orderBy('id','desc')->get();
...
cified resource.
    ...
    {
       /* $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, 'https://app.paydunya.com/sandbox-api/v1/direct-pay/credit-account');
        curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
        curl_setopt($ch, CURLOPT_POST, 1);
        curl_setopt($ch, CURLOPT_POSTFIELDS, "{ \"account_alias\" : \"0140622180\", \"amount\" : 4500 }");

        $headers = array();
        $headers[] = 'PAYDUNYA-MASTER-KEY: N7Dgtnx7-S5Ye-EQbb-fmX6-nM8oNXiaPzOh';
        $headers[] = 'PAYDUNYA-PRIVATE-KEY: test_private_wbM47D0IUFnL1VJSopKOdmPR8U7';
        $headers[] = 'PAYDUNYA-TOKEN: QMizRQ4ofYn6NrG3Tiaj';
